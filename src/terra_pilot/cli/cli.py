...
from terra_pilot.search.index import TerraPilotIndex, BACKEND
...
def _run_list_nl(repo: str, rest: List[str]) -> int:
    ...
    from terra_pilot.models import inventory
    import re
...
def main(argv):
    ...
    if cmd == "stats":
        ...
        from terra_pilot.search.lexical_search import build_hybrid
        ...
        from terra_pilot.llm.agent_tools import tf_search
