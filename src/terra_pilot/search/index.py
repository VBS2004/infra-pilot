...
from terra_pilot.hcl.hcl_parser import Block, parse_hcl as _py_parse_hcl, iter_blocks
from terra_pilot.core.file_cache import FileCache
from terra_pilot.utils.repo_scan import list_hcl_files
...
def _select_backend():
    ...
    try:
        from terra_pilot.utils import ts_backend  # local module; only imports cleanly if tree-sitter is present
