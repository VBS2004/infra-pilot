...
from terra_pilot.search.index import TerraPilotIndex, Symbol
from terra_pilot.llm import gateway
...
def build_hybrid(idx: TerraPilotIndex, persist: bool = True) -> HybridRetriever:
    ...
    if persist:
        try:
            from terra_pilot.core.storage import get_storage
            from terra_pilot.core.persistence import EmbeddingStore, repo_namespace
